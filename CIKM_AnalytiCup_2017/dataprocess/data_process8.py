...
# process wind data
def dataprocess(filename, data_type, windversion, file_index):
    header_list = ['id']
    ...
    with open(filename + file_index) as fr:
        ...
        if windversion == 'old':
            df.to_csv('/data/yuyang/weather/data/data_shenzhen/data_processed/' + data_type + '_' + windversion + '_wind_4240.csv' + file_index, header=head, index=False,
                      float_format='%.3f')
        else:
            df.to_csv('/data/yuyang/weather/data/data_shenzhen/data_processed/' + data_type + '_' + windversion + '_wind_1ave_8extend.csv' + file_index, header=head, 
...
#trainfile = 'C:/Users/user/Documents/cikm/data_new/CIKM2017_train/train.txt'
#testBfile = 'C:/Users/user/Documents/cikm/data_new/CIKM2017_testB/testB.txt'
